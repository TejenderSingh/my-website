      ...
      <main>
        <section class="hero">
          <div class="hero__title">
            I'm
            <span>Tejender Singh</span>
          </div>
          <p class="hero__subtitle">Web Developer</p>
          <p
            class="hero__text"
          >I am a Web Developer based in New Zealand. I love building Responsive, Interactive and User Friendly websites and web applications using latest technologies.</p>
          <div class="buttons">
            <Button
              btnName="About me"
              btnBgColor="var(--main-accent)"
              btnColor="var(--main-darkest)"
              targetPage="/about-me"
            />
          </div>
        </section>
          ...
          <div class="photo__wrapper">
            ...
            >
              ...
              <rect
                ...
                opacity="0.2"
              ></rect>
              <rect x="724.63" y="87" width="52" height="27" fill="var(--main-light)" opacity="0.2"></rect>
              <rect
                x="761.63"
                y="118"
                width="52"
                ...
                opacity="0.2"
              ></rect>
              <rect x="661.63" y="89" width="52" height="27" fill="var(--main-light)" opacity="0.2"></rect>
              <rect
                x="828.63"
                y="149"
                width="52"
              ...
              <path
                ...
                stroke-width="2"
              ></path>
              <rect x="0.63" y="284" width="52" height="27" fill="var(--main-light)" opacity="0.2"></rect>
              <rect x="37.63" y="315" width="52" height="27" fill="var(--main-light)" opacity="0.2"></rect>
              <rect x="318.63" width="52" height="27" fill="var(--main-light)" opacity="0.2"></rect>
              <rect
                x="728.63"
                y="498"
                width="52"
                ...
                opacity="0.2"
              ></rect>
              <rect x="41.63" y="348" width="52" height="27" fill="var(--main-light)" opacity="0.2"></rect>
              <rect x="355.63" y="31" width="52" height="27" fill="var(--main-light)" opacity="0.2"></rect>
              <rect
                x="165.63"
                y="214"
                width="52"
              ...
              <path
                ...
                fill="#e14b5a"
              ></path>
              <ellipse cx="504.24" cy="175.95" rx="86.14" ry="59.19" fill="#e14b5a"></ellipse>
              <path
              ...
              <path
                ...
                opacity="0.1"
              ></path>
              <rect x="590.36" y="143.57" width="7.3" height="41.39" fill="#6a5c99"></rect>
              <path
...
export default {
  ...
  head() {
    return {
      title: "Welcome - Please feel free to browse through my website"
    };
  }
};
</script>
...
// <polygon xmlns="http://www.w3.org/2000/svg" points="519.06 401.13 447.014 472.275 519.06 543.42 535.27 527.21 480.786 472.725 535.72 417.79 519.06 401.13" fill="#6c63ff"/>
// <polygon xmlns="http://www.w3.org/2000/svg" points="625.327 401.13 697.373 472.275 625.327 543.42 609.117 527.21 663.602 472.725 608.667 417.79 625.327 401.13" fill="#6c63ff"/>
</style>
